  ...
  return (
    <svg width="27" height="27" viewBox="0 0 27 27" fill="none">
      <path
        ...
        fill={active ? "var(--color-primary)" : "rgba(255,255,255,0.7)"}
      />
    </svg>
  );
}
...
function ScanIcon({ active }: { active: boolean }) {
  const color = active ? "var(--color-primary)" : "rgba(255,255,255,0.7)";
  return (
    <svg width="27" height="27" viewBox="0 0 27 27" fill="none">
...
export function BottomNav() {
  ...
  return (
    <nav role="navigation" aria-label="Main" className="shrink-0 z-50 safe-bottom">
      ...
      <div className="relative bg-accent rounded-t-[25px] pt-5 pb-2">
        {/* Yellow accent stripe on top-left — per Pencil design */}
        <div className="absolute top-0 left-[36px] w-[38px] h-[5px] bg-primary rounded-b-sm" />
              ...
              return (
                ...
                >
                  ...
                  <div className="w-[78px] h-[78px] rounded-full bg-white p-[5px] shadow-lg">
                    <div className="w-full h-full rounded-full bg-primary flex items-center justify-center active:scale-90 transition-transform duration-100">
                      <Image
