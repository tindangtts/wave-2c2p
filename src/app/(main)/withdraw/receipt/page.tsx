      ...
      <div className="flex-1 overflow-y-auto pb-32">
        ...
        <div className="mx-4 mt-4 bg-white rounded-xl border border-[#E0E0E0] p-4">
          ...
          <div className="flex flex-col items-center pb-4 border-b border-gray-100">
            ...
            <p className="text-[16px] font-bold text-[#00C853]">Completed</p>
          ...
          <div className="mt-4 space-y-3">
            <div className="flex justify-between items-center">
              <span className="text-[12px] text-[#757575]">Type</span>
              <span className="text-[14px] font-bold text-[#212121]">Withdrawal</span>
            </div>

            {recipientName && (
              <div className="flex justify-between items-center">
                <span className="text-[12px] text-[#757575]">Recipient</span>
                <span className="text-[14px] font-bold text-[#212121] text-right max-w-[180px] truncate">
                  {recipientName}
                </span>
              </div>
            )}
