...
-- Enable UUID extension (schema must be 'extensions' on Supabase hosted)
...
-- Phase 20+ tables (notifications, vouchers, system_config, permanently_rejected)
-- are handled by their own migration files: 20260415_add_*.sql
